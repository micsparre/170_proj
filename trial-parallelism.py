...
def solve(G):
    ...
    if G.number_of_nodes() <= 30:
        ...
        p2 = mp.Process(target=solver2, args=(G.copy(), 3, 50, q, ))
        p3 = mp.Process(target=solver3, args=(G.copy(), 3, 50, q, ))
        p4 = mp.Process(target=solver4, args=(G.copy(), 3, 50, q, ))
        p1.start()
        p2.start()
        p3.start()
        p4.start() 
    ...
    print("4: ", path_cost_4 - path_score)
